...
def main():
    ...
    #Set parameters for the planner    z
    ...
    left_pos = input("Enter starting positions for left joint angles: ")
    right_pos = input("Enter starting positions for right joint angles: ")
    total_start = [0.0] + left_pos + right_pos
    print(total_start)
    goal.request.start_state.joint_state.position = total_start
    ...
    left_pos_end = input("Enter ending positions for left joint angles: ")
    right_pos_end = input("Enter ending positions for right joint angles: ")
    total_end = [0.0] + left_pos_end + right_pos_end
    print(total_end)
    target_joint_angles = total_end
    tolerance = 0.0001
    consts = []
