...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_4f.pack(*self.palm_imu_quat))
      _x = self
      buff.write(_struct_2f.pack(_x.joint_angle, _x.proximal))
      buff.write(_struct_4f.pack(*self.finger_imu_quat))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.palm_imu_quat = _struct_4f.unpack(str[start:end])
      _x = self
      start = end
      end += 8
      (_x.joint_angle, _x.proximal,) = _struct_2f.unpack(str[start:end])
      start = end
      end += 16
      self.finger_imu_quat = _struct_4f.unpack(str[start:end])
      return self
