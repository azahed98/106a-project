...
uint16[4] gyr_radius"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_3H.pack(*self.acc_offset_f1))
      buff.write(_struct_3H.pack(*self.acc_offset_f2))
      buff.write(_struct_3H.pack(*self.acc_offset_f3))
      buff.write(_struct_3H.pack(*self.acc_offset_palm))
      buff.write(_struct_3H.pack(*self.mag_offset_f1))
      buff.write(_struct_3H.pack(*self.mag_offset_f2))
      buff.write(_struct_3H.pack(*self.mag_offset_f3))
      buff.write(_struct_3H.pack(*self.mag_offset_palm))
      buff.write(_struct_3H.pack(*self.gyr_offset_f1))
      buff.write(_struct_3H.pack(*self.gyr_offset_f2))
      buff.write(_struct_3H.pack(*self.gyr_offset_f3))
      buff.write(_struct_3H.pack(*self.gyr_offset_palm))
      buff.write(_struct_4H.pack(*self.acc_radius))
      buff.write(_struct_4H.pack(*self.gyr_radius))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.acc_offset_f1 = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.acc_offset_f2 = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.acc_offset_f3 = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.acc_offset_palm = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.mag_offset_f1 = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.mag_offset_f2 = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.mag_offset_f3 = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.mag_offset_palm = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.gyr_offset_f1 = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.gyr_offset_f2 = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.gyr_offset_f3 = _struct_3H.unpack(str[start:end])
      start = end
      end += 6
      self.gyr_offset_palm = _struct_3H.unpack(str[start:end])
      start = end
      end += 8
      self.acc_radius = _struct_4H.unpack(str[start:end])
      start = end
      end += 8
      self.gyr_radius = _struct_4H.unpack(str[start:end])
      return self
